...
const PLATFORM_COLORS: Record<string, string> = { gitlab: '#FC6D26', github: '#24292F', gitea: '#609926', tencent_code: '#1B5E20' }
const PLATFORM_LABELS: Record<string, string> = { gitlab: 'GitLab', github: 'GitHub', gitea: 'Gitea', tencent_code: '腾讯工蜂' }
