...
func Init() {
	...
	err = DB.AutoMigrate(&po.SchemaMigration{}, &po.Repo{}, &po.AuditLog{}, &po.SystemConfig{}, &po.CommitStat{}, &po.NotificationChannel{}, &po.NotificationEventTemplate{}, &po.SSHKey{}, &po.Credential{}, &po.LintRule{}, &po.ProviderConfig{}, &po.ChangeRequest{}, &po.WebhookEvent{}, &po.WebhookRule{}, &po.RepoProviderBinding{}, &po.ReviewTask{}, &po.ReviewFinding{}, &po.ReviewComment{}, &po.MergeCheckResult{}, &po.ReviewRepoConfig{}, &po.LLMProvider{}, &po.BranchRuleSet{}, &po.BranchRuleOverride{}, &po.ReviewRule{}, &po.MaintenanceRecord{}, &po.AuthorIdentity{}, &po.AIInvocation{}, &po.Mirror{}, &po.MirrorSyncLog{})
	if err != nil {
